...
$("createBtn").onclick=async()=>{
  try{$("createBtn").disabled=true;$("createNotice").dataset.kind="";$("createNotice").textContent="جاري إنشاء الغرفة…";const ownerName=$("ownerName").value.trim();if(!ownerName)throw new Error("اكتبي اسم الهوست");const u=await ensureAuth();let code="";
